...
def _get_hf_config(model_id, cache_dir=None):
    ...
    # config_path = "/data/luo/vand3/challenge/checkpoint/CLIP_14_hug_weight/open_clip_config.json"
...
def create_model(
    ...
    if has_hf_hub_prefix:
        ...
        # checkpoint_path = "/data/luo/vand3/challenge/checkpoint/CLIP_14_hug_weight/open_clip_pytorch_model.bin"
        config_path = download_pretrained_from_hf(model_id, filename='open_clip_config.json', cache_dir=cache_dir)
        # config_path = "/data/luo/vand3/challenge/checkpoint/CLIP_14_hug_weight/open_clip_config.json"
