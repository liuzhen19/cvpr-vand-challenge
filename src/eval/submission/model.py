...
class Model(nn.Module):
    ...
    def __init__(self) -> None:
        ...
        # 
        #self.model_clip, _, _ = open_clip.create_model_and_transforms(model_name, img_size= 448 ,pretrained=pretrained)
    ...
    def process_k_shot(self, class_name, few_shot_samples):
        ...
        #few_shot_samples = F.interpolate(few_shot_samples, size=(224, 224), mode=self.inter_mode, align_corners=self.align_corners, antialias=self.antialias)
